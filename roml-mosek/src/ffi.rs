...
extern "C" {
    ...
    // ── Parameters ────────────────────────────────────────────────────────
    pub fn MSK_putintparam(task: MosekTask, param: MosekInt, parvalue: MosekInt) -> MosekRes;
    pub fn MSK_putdouparam(task: MosekTask, param: MosekInt, parvalue: MosekReal) -> MosekRes;
    ...
    // ── Constraint matrix ─────────────────────────────────────────────────
    pub fn MSK_putaij(task: MosekTask, i: MosekInt, j: MosekInt, aij: MosekReal) -> MosekRes;

    // ── Variable type ─────────────────────────────────────────────────────
    pub fn MSK_putvartype(task: MosekTask, j: MosekInt, vartype: MosekInt) -> MosekRes;

    // ── Removing ──────────────────────────────────────────────────────────
    pub fn MSK_removevars(task: MosekTask, num: MosekInt, subset: *const MosekInt) -> MosekRes;
    pub fn MSK_removecons(task: MosekTask, num: MosekInt, subset: *const MosekInt) -> MosekRes;
    ...
    pub fn MSK_getxx(task: MosekTask, whichsol: MosekInt, xx: *mut MosekReal) -> MosekRes;
    pub fn MSK_gety(task: MosekTask, whichsol: MosekInt, y: *mut MosekReal) -> MosekRes;
    pub fn MSK_getslx(task: MosekTask, whichsol: MosekInt, slx: *mut MosekReal) -> MosekRes;
    pub fn MSK_getsux(task: MosekTask, whichsol: MosekInt, sux: *mut MosekReal) -> MosekRes;
    ...
    pub fn MSK_solutiondef(task: MosekTask, whichsol: MosekInt, isdef: *mut MosekInt) -> MosekRes;
}
