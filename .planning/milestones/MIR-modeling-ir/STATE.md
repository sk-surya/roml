...
| MIR-06 | in progress (IR-27, IR-28): M6-0B baseline + journal-fingerprint contract; M6-1A atomic shared-handle seam (ownership fixed) done | `MIR-06-PLAN.md`; `evidence/MIR-06-REPORT.md`; `Model::{normalized_ordinal_fingerprint,normalized_journal_fingerprint,add_variable_array_block,add_parameter_array_block,set_parameter_array}`; `tests/mir06_journal_fingerprint_tests`; `model::mir06_handle_seam_tests`; `python/tests/test_fingerprint.py` |
| MIR-07 | not started | — |
| MIR-08 | not started | — |
