...
**Next gate:** MIR-05 (rule builders) in progress: `MIR-05-PLAN.md`. MIR-04's deferred items and the `bess_mpc.rs` raw benchmark are tracked in `evidence/MIR-04-REPORT.md`.
...
| MIR-05 | planned (IR-26) | `MIR-05-PLAN.md` |
| MIR-06 | not started | — |
| MIR-07 | not started | — |
| MIR-08 | not started | — |
