...
| MIR-06 | in progress (IR-27, IR-28): M6-0B baseline + journal-fingerprint contract; M6-1A Rust shared-handle seam done | `MIR-06-PLAN.md`; `evidence/MIR-06-REPORT.md`; `Model::{normalized_ordinal_fingerprint,normalized_journal_fingerprint,var_handle,param_handle}`; `tests/mir06_journal_fingerprint_tests`; `model::mir06_handle_seam_tests`; `python/tests/test_fingerprint.py` |
| MIR-07 | not started | — |
| MIR-08 | not started | — |
