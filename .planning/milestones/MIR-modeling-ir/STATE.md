...
**Next gate:** MIR-06 (Python arrays/expressions migrated to the shared IR; Python decorator rules wrap the MIR-05 accumulator). MIR-05 satisfies IR-26 at the Rust/shared-IR level; see `evidence/MIR-05-REPORT.md`.
...
| MIR-05 | complete (IR-26): closure rules bulk-commit CSR (`rule_bulk_commits == 1`) | `evidence/MIR-05-REPORT.md`; `MIR-05-PLAN.md`; `src/modeling/rules.rs`; `Model::add_rules`; `tests/mir05_rules.rs`; `model::mir05_rule_tests` |
| MIR-06 | not started | — |
| MIR-07 | not started | — |
| MIR-08 | not started | — |
