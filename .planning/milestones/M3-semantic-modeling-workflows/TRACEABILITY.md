...
| SM-03 Compiler/backend IR | P26 | P34 equivalence and stale-state evidence | Closed in P26 (`M3_P26_COMPILER_BACKEND_IR.md`); P34 equivalence/stale-state evidence pending |
| SM-04 Typed capabilities | P26 | P28/P29/P31/P33 backend features | Closed in P26 (`M3_P26_COMPILER_BACKEND_IR.md`); SM-04.5 foundations (full in P28); P28+/P33 backend features pending |
