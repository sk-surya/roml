...
| MPY-06 | open | typing/wheels/sdist/docs done; journal fix implemented on fix/bounded-sync-journal (#54 draft review); soak PASSES on fix; merge pending separate authorization |
